<script lang="ts">
  ...
  const options = [
    ...
    { title: $t('admin.link_live_photos_all'), value: ManualJobName.LinkLivePhotosAll },
    { title: $t('admin.link_live_photos_missing'), value: ManualJobName.LinkLivePhotosMissing },
